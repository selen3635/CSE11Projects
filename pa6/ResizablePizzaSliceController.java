...
public class ResizablePizzaSliceController extends WindowController 
  ...
  // variables to check whether pizza is dynamic or static
  private boolean isSpin = true;
  private boolean isResize = true;

  /**
   *     This is main method for program, run as an
   *  application with Acme.MainFrame. It will create a new frame.
  ...
  /**
   * This method is going to draw pizzas when user click on vanvas.
  ...
  public void mouseClicked ( MouseEvent evt) {
    ...
    if(evt.getX() != vLine.getStart().getX() &&
      ...
      pizza = new ResizablePizzaSlice( point, PIZZASIZE, canvas,
        hLine, vLine, isSpin, isResize, speed);
  ...
  /**
   * This method is going to check whether user click on lines
   * @param evt   This represent mouse event
   */ 
  ...
  public void actionPerformed( ActionEvent evt) {
    ...
    if ( pizza != null && source == startButton) {
    ...
    else if ( pizza != null && source == stopButton) {
