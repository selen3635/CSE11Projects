...
public class Spin100WheelEC extends ActiveObject {
  ...
  private Spin100ControllerEC controller;
  private int delay;
  ...
  public Spin100WheelEC( Image[] pics, int delay, Location topNumLoc,
                       Spin100ControllerEC controller, int minTicks,
