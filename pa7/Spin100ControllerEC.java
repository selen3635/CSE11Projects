...
public class Spin100ControllerEC extends WindowController implements
                               ActionListener{
  ...
  private Text overallWin;

  // create new variable to track how many times player win
  private int winTime1;
  private int winTime2;

  // array to store images
  private Image [] playerArray = new Image[ARRAYSIZE];

  // create two wheel variables
  private Spin100WheelEC leftWheel;
  private Spin100WheelEC rightWheel;
  ...
  public static void main(String [] args) {
    ...
    new Acme.MainFrame ( new Spin100ControllerEC(), args, 
  ...
  public void begin () {
    ...
    // create tie message and set color and bold
    ...
    // create player 1 winner message and set color and bold
    ...
    // create player 2 winner message and set color and bold
    ...
    // create overall win meesage and set color and bold
    overallWin = new Text("Overall Wins P1: " + winTime1 + ", P2: " +
        winTime2, FRAME_WIDTH / HALF,
         POINTER_Y, canvas);

    overallWin.moveTo( FRAME_WIDTH / HALF - overallWin.getWidth() / HALF,
        WHEEL_Y_COORD + IMAGE_HEIGHT + IMAGE_HEIGHT / FOUR);
    overallWin.setColor(Color.RED);
    overallWin.setBold(true);
  ...
  public void actionPerformed ( ActionEvent evt) {
    ...
    // check if player 2 click on finish button
     ...
     overallWin.setText("Overall Wins P1: " + winTime1 + ", P2: " +
            winTime2);
      overallWin.show();
  ...
  public void getImage () {
    ...
    leftWheel = new Spin100WheelEC( playerArray, WHEEL_DELAY, topLeftLoc,
                                  this, MIN_TICKS, canvas);

    rightWheel = new Spin100WheelEC( playerArray, WHEEL_DELAY, topRightLoc,
                                  this, MIN_TICKS, canvas); 
  }
